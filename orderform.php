...
<body>
    <div id="wrapper">
                ...
                <a href="orderformEng.php"><img src="slike/eng.png" id="desnaSlika" alt="" width="60px;"></a>

                <input type="submit" name="submit" value="Kasa"><br>
              ...
              <p id="mejl"><a href="slanjeMejla.php">Postavite pitanje</a></p>
